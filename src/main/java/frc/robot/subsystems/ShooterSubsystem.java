...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public ShooterSubsystem() {
        leftFlywheelNeo = new CANSparkMax(Constants.Shooter.LEFT_FLYWHEEL_MOTOR_ID, MotorType.kBrushless);
        rightFlywheelNeo = new CANSparkMax(Constants.Shooter.RIGHT_FLYWHELL_MOTOR_ID, MotorType.kBrushless);
